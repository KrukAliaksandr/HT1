...
public class ManagePersonServlet extends HttpServlet {
    ...
    public ManagePersonServlet()
    {
        ...
        try
		{
			this.phonebook = app.Phonebook.getInstance();
		}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		RequestDispatcher dispatcher_for_simple = request.getRequestDispatcher("/Simple.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (edit_go != null)
		{
			...
			newPhones = new HashMap<String,String>();
			newPhones.put("1",request.getParameter("phones"));
			updatable_person.setPhones(newPhones);
